extends PlayerBase
class_name PlayerExplosive

@export var bullet_scene: PackedScene

func shoot():
	print("Disparo explosivo iniciado!")
	...
	bullet.shooter = self
	bullet.velocity = shoot_direction * bullet.speed
	bullet.global_position = muzzle.global_position + shoot_direction * 10  # desloca para frente
